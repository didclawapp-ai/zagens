...
> **Zagens shell version:** 0.9.0+ | **Last updated:** 2026-07-21 | **Authoritative implementation:** `crates/runtime-server/src/tools/` (formerly `crates/tui/src/tools/`), `registry.rs`  
