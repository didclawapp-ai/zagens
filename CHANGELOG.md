...
- **Architecture / D7 Phase C kickoff (2026-05-26):** [`D7_PERSISTENCE_UNIFICATION.md`](docs/tech/adr/D7_PERSISTENCE_UNIFICATION.md) — spike + PR 链（C1–C6）；**C1** 修复 `sessions.db` 未持久化 `runtime_thread_id`（`session_store_sqlite` 列补丁 + round-trip 测试）。
