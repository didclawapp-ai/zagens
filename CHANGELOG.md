...
- **Architecture / D7 Phase C kickoff (2026-05-26):** [`D7_PERSISTENCE_UNIFICATION.md`](docs/tech/adr/D7_PERSISTENCE_UNIFICATION.md) — spike + PR 链（C1–C6）；**C1** `runtime_thread_id` SQLite；**C3** `session_resume_reuses_runtime_thread_when_sqlite_has_link` 集成测。交接：[`D7_HANDOFF.md`](docs/tech/adr/D7_HANDOFF.md)。
