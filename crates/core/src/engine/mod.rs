...
pub use turn_machine::{
    ...
    KernelResumeHints, LiveTurnSnapshot, ReplayTurnMachine, SessionCompactionArtifactEntry,
    SessionMessageCoverage, SessionMessageRoleIndex, SessionMessageTimelineCoverage, StepOutput,
    ThreadCompactionReplayEntry, ThreadCompactionReplayIndex, ThreadMessagePlaneIndex,
    ...
    TurnReplayReport, build_session_compaction_artifact_index, build_session_message_coverage,
    build_session_message_role_index, build_session_message_timeline_coverage,
    build_thread_replay_report, compaction_messages_removed_count, compare_projection_to_live,
    emit_kernel, emit_kernel_event, events_for_step, kernel_resume_hints_from_projection,
    ...
    replay_thread_compaction_timeline, replay_thread_message_plane_index,
    replay_thread_message_stats, replay_thread_message_timeline, replay_thread_projection,
    replay_turn_effects, replay_turn_projection, verify_compaction_artifacts_vs_kernel_timeline,
