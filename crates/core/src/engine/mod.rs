...
pub use turn_machine::{
    ...
    KernelResumeHints, LiveTurnSnapshot, ReplayTurnMachine, SessionMessageCoverage,
    SessionMessageRoleIndex, SessionMessageTimelineCoverage, StepOutput, ThreadMessagePlaneIndex,
    ThreadMessageReplayStats, ThreadMessageTimelineEntry, ThreadReplayProjection,
    ThreadReplayReport, ThreadTurnReplaySummary, TurnKernelProjection, TurnMachine,
    TurnReplayReport, build_session_message_coverage, build_session_message_role_index,
    build_session_message_timeline_coverage, build_thread_replay_report,
    compare_projection_to_live, emit_kernel, emit_kernel_event, events_for_step,
    kernel_resume_hints_from_projection, kernel_resume_hints_from_thread_projection,
    outcome_from_status, plan_v3_step_effects, replay_effect_counts,
    replay_kernel_memory_plane_user_estimate, replay_kernel_message_role_estimate,
    replay_step_effects, replay_thread_message_plane_index, replay_thread_message_stats,
    ...
    verify_message_timeline_vs_session, verify_session_memory_plane_user_depth,
    verify_session_message_coverage, verify_session_message_plane_depth, verify_session_role_index,
    verify_step_effect_parity, verify_step_model_message_anchor, verify_timeline_vs_request_count,
