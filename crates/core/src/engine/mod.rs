...
pub use turn_machine::{
    ...
    build_thread_replay_report, compaction_messages_removed_count,
    compaction_run_effects_from_events, compare_projection_to_live,
    continuation_inject_steer_effects_for_step, emit_kernel, emit_kernel_event, events_for_step,
    is_compaction_run_kernel_event, is_lsp_notify_tool, is_memory_plane_injection_kernel_event,
    kernel_resume_hints_from_projection, kernel_resume_hints_from_thread_projection,
    memory_plane_inject_steer_effects_from_events, notify_lsp_effects_from_step_events,
    ...
    replay_step_effects, replay_thread_compaction_index, replay_thread_compaction_timeline,
    replay_thread_effect_counts, replay_thread_message_plane_index, replay_thread_message_stats,
    replay_thread_message_timeline, replay_thread_projection, replay_turn_effects,
    replay_turn_projection, verify_compaction_artifacts_vs_kernel_timeline,
