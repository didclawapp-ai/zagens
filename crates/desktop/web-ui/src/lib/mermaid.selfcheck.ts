/**
 * Mermaid helpers self-check (run: npm run test:mermaid).
 */
...
async function runSanitizeTests(): Promise<void> {
  try {
    ...
    console.warn(
      'mermaid self-check: skipped DOMPurify tests:',
...
console.log('mermaid self-check passed');
