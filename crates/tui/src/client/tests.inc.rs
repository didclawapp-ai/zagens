...
use self::http::{api_url, build_default_headers, force_http1_from_env};
...
use self::types::{
    ...
    ConnectionHealth, ConnectionState, TokenBucket, RECOVERY_PROBE_COOLDOWN, release_stream_buffer,
};
