...
<title>DS Pick Session Export</title>
<style>
  body {{
...
mod tests {
    ...
    fn test_render_session_html_metadata() {
        ...
        assert!(html.contains("Generated by DS Pick"));
    }
}
