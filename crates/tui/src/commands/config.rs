...
pub use crate::auto_route::{
    auto_model_heuristic, AutoRouteRecommendation, AutoRouteSelection, AutoRouteSource,
    normalize_auto_route_effort, parse_auto_route_recommendation, resolve_auto_route_with_flash,
