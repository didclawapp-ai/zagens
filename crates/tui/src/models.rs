...
pub use deepseek_core::chat::{
    CacheControl, ContainerInfo, ContentBlock, ContentBlockStart, Delta, Message, MessageDelta,
    MessageRequest, MessageResponse, StreamEvent, SystemBlock, SystemPrompt, Tool, ToolCaller,
    compaction_threshold_for_model, compaction_threshold_for_override, context_window_for_model,
    DEEPSEEK_V4_CONTEXT_WINDOW_TOKENS, DEFAULT_COMPACTION_TOKEN_THRESHOLD,
