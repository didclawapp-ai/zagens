...
pub use lht_config::{
    ...
    LongHorizonConfigToml, MacroLoopConfigToml, MinLinesGateToml, normalize_gate_mode,
    normalize_lht_mode, product_defaults as lht_product_defaults, resolve_lht,
    sync_long_horizon_with_composer_mode,
};
...
pub use ui_settings::{
    ...
    read_lht_strict_setting, read_locale_setting, read_new_session_use_worktree_setting,
    read_onboarding_complete_setting, read_task_type_preference_setting, settings_path,
    write_lht_composer_mode_setting, write_lht_strict_setting, write_locale_setting,
    write_new_session_use_worktree_setting, write_onboarding_complete_setting,
