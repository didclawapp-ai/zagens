...
use super::super::{
    ...
    DEFAULT_DEEPSEEK_CN_MODEL, DEFAULT_DEEPSEEK_MODEL, DEFAULT_DEEPSEEKCN_BASE_URL,
    ...
    DEFAULT_OLLAMA_BASE_URL, DEFAULT_OLLAMA_MODEL, DEFAULT_OPENAI_BASE_URL, DEFAULT_OPENAI_MODEL,
    DEFAULT_OPENROUTER_BASE_URL, DEFAULT_OPENROUTER_MODEL, DEFAULT_SENSENOVA_BASE_URL,
    DEFAULT_SENSENOVA_MODEL, DEFAULT_SGLANG_BASE_URL, DEFAULT_SGLANG_MODEL, DEFAULT_VLLM_BASE_URL,
...
impl Config {
    ...
    pub fn default_model(&self) -> String {
        ...
        match provider {
            ApiProvider::Deepseek => DEFAULT_DEEPSEEK_MODEL,
            ApiProvider::DeepseekCN => DEFAULT_DEEPSEEK_CN_MODEL,
