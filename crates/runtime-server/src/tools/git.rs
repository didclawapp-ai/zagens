...
/// process hanging indefinitely (e.g. waiting on a credential prompt or a
/// wedged lock); `GIT_TERMINAL_PROMPT=0` additionally disables the interactive
/// prompt that is the most common cause.
