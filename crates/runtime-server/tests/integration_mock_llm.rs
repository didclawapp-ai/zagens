...
//! directly. Full engine integration with the mock client lives in
//! `crates/tui/src/core/engine/tests.rs` (`engine_llm_client_override_runs_mock_turn`).
...
// Full engine + mock LLM turn: see `engine_llm_client_override_runs_mock_turn` in
// `crates/tui/src/core/engine/tests.rs` (A5.2 / #402).
