...
fn pricing_for_model(model: &str) -> Option<ModelPricing> {
    ...
    // DeepSeek Platform published rates
    // (https://api-docs.deepseek.com/quick_start/pricing as of 2026-07-31):
    // deepseek-v4-flash → DeepSeek-V4-Flash-0731; deepseek-v4-pro → DeepSeek-V4-Pro.
    if lower.contains("v4-pro") || lower.contains("v4pro") {
        ...
        // deepseek-v4-flash / DeepSeek-V4-Flash-0731 pricing.
        Some(ModelPricing {
            usd: CurrencyPricing {
...
mod tests {
    ...
    #[test]
    fn v4_pro_uses_current_published_rates() {
    ...
    #[test]
    fn v4_flash_0731_uses_current_published_rates() {
        ...
        let alias = pricing_for_model("deepseek-v4-flash-0731").unwrap();
        assert_eq!(
            alias.usd.input_cache_miss_per_million,
