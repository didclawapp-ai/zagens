...
- **Versions:** Zagens uses its **own** SemVer; pre-1.0 public releases default to **`0.x.y-preview.n`** (e.g. **`0.6.0-preview.1`**), separate from the embedded runtime workspace line; see [`docs/desktop/VERSIONING.md`](docs/desktop/VERSIONING.md) and [`CHANGELOG.md`](CHANGELOG.md) header.
