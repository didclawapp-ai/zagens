...
**Installed builds:** `bundle:prepare` stages `third-party/deepseek-tui/LICENSE` into the desktop bundle as `legal/deepseek-tui-runtime-LICENSE.txt` (alongside `legal/THIRD-PARTY-NOTICES.txt`) next to the application binary.
